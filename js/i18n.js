...
(function () {
  ...
  var TEXT = {
    ...
    /* /listen (17 Sep 2026) */
    "Listen": { es: "Escuchar", pt: "Ouvir" },
    "Pre-save": { es: "Pre-guardar", pt: "Pré-salvar" },
    "Watch": { es: "Ver", pt: "Assistir" },
    "Stream": { es: "Escuchar en", pt: "Ouvir em" },
    "Follow": { es: "Seguir", pt: "Seguir" },
    "Write to us": { es: "Escríbenos", pt: "Escreva pra gente" },
    "The number": { es: "La cifra", pt: "O número" },
    "Latest · Magic Records · 2024": { es: "Lo último · Magic Records · 2024", pt: "Mais recente · Magic Records · 2024" },
    "Streams across Spotify, Apple Music, YouTube and SoundCloud": { es: "Reproducciones en Spotify, Apple Music, YouTube y SoundCloud", pt: "Streams no Spotify, Apple Music, YouTube e SoundCloud" },
    "as of": { es: "a", pt: "em" },
    ...
    "Where do I download it?": { es: "¿Dónde lo descargo?", pt: "Onde faço o download?" },
    "Right here, before or after you buy. The installers are free; the plugin passes audio through clean until a key is entered.": { es: "Aquí mismo, antes o después de comprar. Los instaladores son gratis; el plugin deja pasar el audio limpio hasta que introduces una clave.", pt: "Aqui mesmo, antes ou depois de comprar. Os instaladores são grátis; o plugin deixa o áudio passar limpo até inserires uma chave." },
    "macOS installer": { es: "Instalador para macOS", pt: "Instalador para macOS" },
    "Windows installer": { es: "Instalador para Windows", pt: "Instalador para Windows" },
    "macOS 11 or later, Apple silicon and Intel, signed and notarised by Apple. Windows 10 or later, 64-bit. Your key also arrives with both links in the email.": { es: "macOS 11 o posterior, Apple silicon e Intel, firmado y notarizado por Apple. Windows 10 o posterior, 64 bits. Tu clave también llega con ambos enlaces en el email.", pt: "macOS 11 ou posterior, Apple silicon e Intel, assinado e notarizado pela Apple. Windows 10 ou posterior, 64 bits. A tua chave também chega com os dois links no e-mail." },
    "50% off for the first 300 buyers": { es: "50% de descuento para los primeros 300 compradores", pt: "50% de desconto para os primeiros 300 compradores" },
    "Installers are free to download. The key unlocks them.": { es: "Los instaladores se descargan gratis. La clave los desbloquea.", pt: "Os instaladores são grátis para descarregar. A chave desbloqueia-os." },
    ...
    /* update page (updatecleanslate.html) — runtime strings composed by js/update.js + the static chrome */
    "Update to": { es: "Actualiza a", pt: "Atualize para" },
    "now": { es: "ahora", pt: "agora" },
    "You are on version": { es: "Tienes la versión", pt: "Você está na versão" },
    "You're on the": { es: "Tienes la", pt: "Você está na" },
    "latest": { es: "última", pt: "última" },
    "version": { es: "versión", pt: "versão" },
    "Version": { es: "Versión", pt: "Versão" },
    "released": { es: "publicada el", pt: "lançada em" },
    "updates": { es: "actualizaciones", pt: "atualizações" },
    "The latest installers are below.": { es: "Los últimos instaladores están abajo.", pt: "Os instaladores mais recentes estão abaixo." },
    "Open CLEANSLATE and press CHECK FOR UPDATE in the footer to see your version.": { es: "Abre CLEANSLATE y pulsa CHECK FOR UPDATE en el pie de la ventana para ver tu versión.", pt: "Abra o CLEANSLATE e clique em CHECK FOR UPDATE no rodapé da janela para ver a sua versão." },
    "Download": { es: "Descargar", pt: "Baixar" },
    "Download for macOS": { es: "Descargar para macOS", pt: "Baixar para macOS" },
    "Download for Windows": { es: "Descargar para Windows", pt: "Baixar para Windows" },
    "Your licence stays. Install over the top, reopen your DAW, done.": { es: "Tu licencia se queda. Instala encima, vuelve a abrir tu DAW y listo.", pt: "A sua licença fica. Instale por cima, reabra o seu DAW, pronto." },
    "Plugin store": { es: "Tienda de plugins", pt: "Loja de plugins" },
    "Release history": { es: "Historial de versiones", pt: "Histórico de versões" },
    "Updating": { es: "Actualizar", pt: "Atualizar" },
    "Do I need my key again?": { es: "¿Necesito mi clave otra vez?", pt: "Preciso da minha chave de novo?" },
    "Will my presets and sessions survive?": { es: "¿Sobreviven mis presets y sesiones?", pt: "Meus presets e sessões sobrevivem?" },
    "How do I know which version I have?": { es: "¿Cómo sé qué versión tengo?", pt: "Como sei qual versão tenho?" },
  };

  /* ---------- markup blocks (selector -> innerHTML; array = per match) --- */
  var HTML = [
    { sel: ".upd-new h2",
      es: "Hecho para seguir <span class=\"em\">mejorando</span>.",
      pt: "Feito para continuar <span class=\"em\">melhorando</span>." },
    { sel: ".upd-history h2",
      es: "Cada <span class=\"em\">versión</span>.",
      pt: "Cada <span class=\"em\">versão</span>." },
    { sel: "#upd-faq h2",
